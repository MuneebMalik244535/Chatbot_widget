...
export const ChatWindow = ({
  ...
  return (
    <div className="fixed bottom-20 right-4 w-96 max-w-[calc(100vw-2rem)] h-[600px] max-h-[85vh] bg-white rounded-2xl shadow-2xl flex flex-col overflow-hidden z-50 animate-slide-up md:bottom-24 md:right-6">
      {/* Header */}
      <div className="bg-gradient-to-r from-primary-600 to-primary-700 text-white p-4 flex justify-between items-center">
        <div>
          <h2 className="font-bold text-lg">Bright Smile Clinic</h2>
        ...
        {messages.length === 0 && (
          <div className="flex flex-col items-center justify-center h-full text-center">
            ...
            <p className="text-gray-600 font-semibold">
              Welcome to Bright Smile Clinic!
            </p>
      ...
      <div className="border-t border-gray-200 p-4 bg-white">
        <div className="flex space-x-2">
          ...
          <button
            ...
            className="bg-primary-600 hover:bg-primary-700 disabled:bg-gray-300 text-white rounded-lg px-4 py-2 transition flex items-center space-x-2"
